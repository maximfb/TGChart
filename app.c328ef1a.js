...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"modules/utils.js":[function(require,module,exports) {
"use strict";
...
exports.computeBounderies = computeBounderies;
...
function toDate(timestamp) {
  var shortMouths = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  var date = new Date(timestamp);
  return "".concat(shortMouths[date.getMonth()], " ").concat(date.getDate());
}
...
function circle(ctx, _ref2, _ref3, rad) {
...
function computeBounderies(_ref5) {
...
},{}],"modules/tooltip.js":[function(require,module,exports) {
"use strict";
...
},{"./utils":"modules/utils.js"}],"modules/slider.js":[function(require,module,exports) {
"use strict";
...
function sliderChart(root, data, DPI_WIDTH) {
  ...
  function mousedown(event) {
    ...
    if (type === 'window') {
      ...
      document.onmousemove = function (e) {
        ...
        var left = demensions.left - delta;
        var right = WIDTH - left - demensions.width;
      ...
      document.onmousemove = function (e) {
        ...
        if (type === 'left') {
          var left = WIDTH - (demensions.width + delta) - demensions.right;
          var right = WIDTH - (demensions.width + delta) - demensions.left;
          setPosition(left, right);
        } else {
          var _right = WIDTH - (demensions.width - delta) - demensions.left;

          setPosition(demensions.left, _right);
        }
  ...
  var _computeBounderies = (0, _utils.computeBounderies)(data),
      _computeBounderies2 = _slicedToArray(_computeBounderies, 2),
      yMin = _computeBounderies2[0],
      yMax = _computeBounderies2[1]; // const yRatio = DPI_HEIGHT / (yMax - yMin)
...
},{"./utils":"modules/utils.js"}],"modules/chart.js":[function(require,module,exports) {
"use strict";
...
function chart(root, data) {
  ...
  function paint() {
    ...
    var _computeBounderies = (0, _utils.computeBounderies)({
      columns: columns,
      types: data.types
    }),
        _computeBounderies2 = _slicedToArray(_computeBounderies, 2),
        yMin = _computeBounderies2[0],
        yMax = _computeBounderies2[1]; // if (!prevMax) {
    //     prevMax = yMax
    //     proxy.max = yMax
    // }
...
},{"./tooltip":"modules/tooltip.js","./utils":"modules/utils.js","./slider":"modules/slider.js"}],"data.js":[function(require,module,exports) {
"use strict";
...
var _chart = require("./modules/chart");

var _data = require("./data");

require("./styles.scss");

var tgChart = (0, _chart.chart)(document.querySelector('#chart'), (0, _data.getChartData)()).init();
},{"./modules/chart":"modules/chart.js","./data":"data.js","./styles.scss":"styles.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
